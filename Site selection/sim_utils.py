...
# -----------------------
def first_map(boundaries, spots, candidates):

    """
    This function plots the distribution of heart attack events and candidate hospital locations.
    """
    # Cluster colors
    colormap = plt.colormaps["tab10"]
    
    # Drawing the map
    map_quebec = folium.Map(location=[46.766429, -71.289947], zoom_start=10)
